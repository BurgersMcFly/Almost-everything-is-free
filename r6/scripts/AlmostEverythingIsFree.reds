// AlmostEverythingIsFree, Cyberpunk 2077 mod that makes almost everything free
...
// along with this program.  If not, see <https://www.gnu.org/licenses/>.
 ...
 @replaceMethod(MarketSystem)
   ...
   public final static func GetBuyPrice(vendorObject: wref<GameObject>, itemID: ItemID) -> Int32 {
    ...
    return (RPGManager.CalculateBuyPrice(vendorObject.GetGame(), vendorObject, itemID, vendor.GetPriceMultiplier()))*0;
  }